######22-10-2015 Added this project by using maven archetype which have by default used hibernate 3 version jars. These version needs to be update for using hibernate4
